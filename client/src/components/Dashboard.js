      ...
      >
        <Box sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            ...
            >
              To get started, please add your Clash Royale player tag in
              settings. This will allow us to display your game statistics and
              track your progress.
            </Typography>
          </Box>
    ...
    >
      ...
      >
        <Toolbar sx={{ display: "flex", alignItems: "center" }}>
          ...
          >
            <SportsEsportsIcon
              sx={{ fontSize: 14, color: pokemonStyles.colors.red }}
            />
          </Box>
            ...
            <Box sx={{ px: 3 }}>
              ...
              >
                ...
                {loading ? (
                  ...
                  >
                    <CircularProgress
                      sx={{ color: pokemonStyles.colors.blue, mb: 2 }}
                    />
                    <Typography
                      variant="body2"
                      sx={{
